...
# The idea is that you have already built the ALmixer .so and .a libraries using CMake.
...
# 
# This file assumes you built all your ALmixer libs and put things into a directory structure like so:
# 
# Android.mk (this file)
# 	libs/armeabi/libALmixer.a
# 	libs/armeabi/libALmixer.a
# 	libs/armeabi-v7a/libALmixer.a
# 	libs/armeabi-v7a/libALmixer.a
...
# These are the LOCAL_MODULE names as defined in the prebuilt module's Android.mk. Define either shared or static, but not both. If you use dynamic, don't forget you need to do a System.loadLibrary("ALmixer") in your Java code.
